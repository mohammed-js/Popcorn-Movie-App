...
import { MovieList } from '../general-paths-index';
import { useGetMovieQuery, useGetRecommendationsQuery, useGetListQuery } from '../../services/TMDB';
import { selectGenreOrCategory } from '../../app/StoreSlices/genreOrCategorySlice';
...
function MovieInfo() {
  ...
  useEffect(() => {
    // [!!] => to get the bolean equavelent of any value
    // [ex: "Ali" => a truly value] (1st !) => false | (2nd !) => true (bolean equavelent)
    // [ex: "Ali" => a falsy value] (1st !) => true | (2nd !) => false (bolean equavelent)
